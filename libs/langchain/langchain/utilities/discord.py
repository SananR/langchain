...
class DiscordAPIWrapper(BaseModel):
    ...
    def validate_environment(cls, values: dict) -> dict:
        ...
        channel_id = get_from_dict_or_env(
            values, "channel_id", "DISCORD_CHANNEL_ID", default=None
        )
    ...
    async def create_text_channel(self, ctx, channel_name: str, *usernames: str):
        ...
        if usernames:
            users = [
                discord.utils.get(ctx.guild.members, name=username)
            ...
            try:
                ...
                return (
                    "I do not have the necessary permissions to create text channels."
                )
    ...
    def delete_text_channel(self, ctx, channel_name: str):
        ...
        channel = discord.utils.get(
            ctx.guild.channels, name=channel_name, type=discord.ChannelType.text
        )
        if not channel:
    ...
    async def create_voice_channel(self, ctx, channel_name: str, *usernames: str):
        ...
        if usernames:
            ...
            try:
                ...
                return (
                    "I do not have the necessary permissions to create voice channels."
                )
    ...
    def delete_voice_channel(self, ctx, channel_name: str = None):
        ...
        channel = discord.utils.get(
            ctx.guild.channels, name=channel_name, type=discord.ChannelType.voice
        )
        if not channel:
    ...
    async def edit_message(self, ctx, new_content: str, channel_name: str = None):
        ...
        try:
            ...
            message = discord.utils.get(
                await channel.history().flatten(), author=ctx.author
            )
            if not message:
